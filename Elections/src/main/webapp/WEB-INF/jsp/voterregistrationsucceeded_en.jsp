...
<div  class="popupBox"  style="color: red; font-size: 20px;" >
		<h4 style="margin-left: 30px; ">
			<p style="color: black; padding-top: 30px; "> 
				You have successfully registered as new voter, to login with your credentials you entered please click <a href="/logoutPage">Log in</a>
			</p>
		</h4>
</div>			
...
<!-- You have successfully registered as new voter, to login with credentials you entered please click <a href="/logoutPage">Log in</a> -->
