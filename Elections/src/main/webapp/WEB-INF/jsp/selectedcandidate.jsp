		...
		<tr>
			<td style="width:20%;">
				<p style=" margin-top: 1px;">
					<span>مرحبا بالناخب<br> ${voterData.fullName}</span>   
				</p>
			</td>
			<td style="width: 10%">
			</td>
...
<table >
	<tr>
		<td>
			<label style="font-size: 20px; font-weight: bold; margin-left: 400px;">شاشه مرشحك الانتخابي الذي قمت بالتصويت له</label>
		</td>
	</tr>
	<tr>
		<!--Table1 -->
		...
		<td>
			<table style="margin-top: -30px;">
				<tr dir="rtl">
					<td>
						<a href="#" style="font-size: 20px; margin-left: 60px;">مجموع الأصوات  
	...
	<tr>
		<td>
			<form action="signin" method = "GET">    
				 ...
				 <input type="submit" value="الصفحة الرئيسية" id="backId" name="Back" class="button"> 
			</form>
		</td>
	</tr> 
</table>
