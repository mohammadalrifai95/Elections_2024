...
<!-- <div dir="rtl" style="border: 3px solid #73AD21; background-color: #679FAB; width: 70%; padding-right:5%;padding-left:5%; margin-right:5%; margin-left:5%; color: white;"> -->
	...
	<!--class="fixedElement"  -->
	<div    style="border: 3px solid #73AD21; background-color: #679FAB; width: 1100px;height:130px; " dir="rtl">
	    <div id="load"></div>
	    <div id="contents">
	    </div>
	       
		<table style="width:1100px; font-size: 35px; font-weight: bold;" dir="rtl">             
			<tr >
				<td dir="rtl">            
				...
				<td >          
						مرحبًا بك في تطبيق نظام الانتخابات <br> هذه هي صفحة تسجيل الدخول
				</td>
	...
	<div class='parent' id="englishDiv" style="">  
	
		<!-- margin-right:250px; -->
		<div class='child'  style=" width: 30%; border : none !important;  font-size: 33px; font-weight: bold; margin-top: 180px;" dir="rtl" >
				<div id="barRegist" style="margin-left: 1px;">
					 <h4 id="errorId" style= "color:red"> </h4>
					  اذا لم تقم بالتسجيل مسبقا الرجاء التسجيل هنا
					  <br>
					...
					<button type="button" onclick="checkButton()"  style="background:black; color:white; width:150px; height:70px;	border-radius: 10px; cursor: pointer; font-size: 33px; margin-top: 10px;"> التالي </button>
...
<!-- 							<button type="button" onclick="checkButton()"  style="background:black; color:white; width:250px; height:44px;	border-radius: 10px; cursor: pointer;  margin-top: 10px; font-size: 33px; font-weight: bold;"> التالي </button> -->
<!-- 						</div> -->
<!-- 					 </div> -->
				</div>	
<!-- 			<div > -->
<!-- 				<br class="verticalSpace">     -->
<!-- 				<a href="#" >هل نسيت  اسم المستخدم؟ </a> -->
<!-- 				<br> -->
...
<!-- 			</div> -->
		...
		<!-- -----------------------------------------Login Part------------------------------------------------------------------------------------------------------------------- -->
			<div id="loginDiv" style="margin-top: 25px; font-size: 33px; font-weight: bold; height:470px;  "  dir="rtl" >
				<form action="signin" method = "GET">
					<span style="margin-left: 10px;">  اسم المستخدم : </span>
						<br>
					 	<input  type="text" name="userName"  id="userName" value=""  style="border:solid; width: 100%;; height: 50px;" dir="rtl"/>
					 	<br> 
					 	<br> 
	
					 <span style="margin-left: 12px;">  كلمة المرور :</span>
					 	<br>
					  	<input  type="password" name="password"  id="password" value=""  style="border:solid; margin-left: 1%; width: 100%;; height: 50px;" dir="rtl"  />
					  	<br>
					  	<br>

					  	<span style="margin-left: 12px;"> الرقم الوطني :</span>
					 	<br>
					  	<input  onchange="handleChange(this);" type="number" name="ssn"  id="ssn" value=""  style="border:solid; margin-left: 1%; width: 100%;; height: 50px;" dir="rtl"  />
					  	<br>
					  	<br>
					  	<br>
	
					 	<input type="submit" value="تسجيل الدخول" id="Login" name="Login"  onclick="SigninButtonFun()"  style="border:solid; width: 100%; height: 55px; font-size: 33px; font-weight: bold;" dir="rtl">
					 	<br>
					 	<br>
				</form>
			</div>
