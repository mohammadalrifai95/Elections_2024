...
<div style="background: #679FAB; width: 600px; height: 360px; margin-top: 100px; " id="blueDivId" class="centerDiv" >  
		...
		<tr>
			<td>
				<span style="float: left; margin-left: 40px; font-size:25px;">
					لقد قمت بالتصويت بنجاح
				</span>
				<br>
				<span style="float: left; font-size:25px;">
					لكي تتمكن من رؤيه التحديث الجديد يرجى تسجيل الدخول
				</span>
			</td>
		</tr>
	</table>
	...
	<table style="width: 600px;height: 180px;  margin-left: 100px; ">
		<tr>
			<td><a href="/" style="font-size:25px; font-weight: bold;">الصفحة الرئيسية</a></td>  
			<td><a href="/logoutPage" style="font-size:25px; font-weight: bold;">تسجيل الدخول</a></td>
		</tr>
	</table>
