...
<div  class="center" dir="rtl"> 
	...
	<div  class="popupBox"  style="font-size: 20px; font-size: 25px; font-weight: bold;" >
		<p style=" padding-top: 30px; text-align: center;"> 
			 لقد قمت بالتسجيل بنجاح كمرشح جديد، لتسجيل الدخول باستخدام بيانات الاعتماد الخاصة بك التي أدخلتها يرجى النقر على الرابط هذا  <a href="/logoutPage">تسجيل الدخول</a>
		</p>
	</div>
