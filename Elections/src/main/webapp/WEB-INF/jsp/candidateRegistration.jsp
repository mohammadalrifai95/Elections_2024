									...
									<tr>
									 ...
									 <tr >
									 	<td dir="rtl"><label class="required">
									 		...
									 		<input type="text" placeholder="اسم المستخدم" id="userName" name="userName" value=""  class="input" disabled="block" />
									 	</td>
									 </tr>
	 							 	 <tr >  
									 	<td dir="rtl">
									 	...
									 	<input type="password" placeholder="كلمة المرور" id="password"  name="password" value="" class="input" disabled="block"/></td>	
									 </tr>	  
									 <tr >
									 	<td dir="rtl">
									 	<label class="required">
									 	</label> أدخل اسمك الكامل كما يظهر في هويتك الأردنية<br /> 
									 	<input type="text" id="fullName" name="fullName" placeholder=" أدخل اسمك الكامل كما يظهر في هويتك الأردنية" value=""  class="input" disabled="block"/></td>
									 </tr>	 
									 <tr>
										<td dir="rtl">
									 	<label class="required">
									 	</label> أدخل رقمك الوطني كما هو موجود في بطاقتك الأردنية<br /><input type="number" placeholder="الرجاء ادخال ارقام فقط" id="ssn" name="ssn" maxlength="10" value=""  class="input" style="margin-left: 1%;" disabled="block"/></td>
									</tr>
									 <tr>
										<td dir="rtl">
									 	<label class="required">
									 	</label> قم بتأكيد رقمك الوطني<br /><input type="number" placeholder="الرجاء ادخال ارقام فقط" id="ssnConfirmation"  maxlength="10"  name="ssnConfirmation"  value=""  class="input" style="margin-left: 1%;" disabled="block"/></td>
									</tr>																 
									 <tr>
									 	<td dir="rtl">
									 	<label class="required">
									 	</label>  رقم هاتفك <br /><input type="number" placeholder="الرجاء ادخال ارقام فقط" id="mobile" name="mobile" value=""  class="input" disabled="block"/></td>
									 </tr>
									 <tr>
									 	<td dir="rtl"> بريدك الالكتروني<br /><input type="text" id="email" placeholder="بريدك الالكتروني"  name="email"  value="" class="input" disabled="block" title="email" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}"/></td>
									 </tr>
