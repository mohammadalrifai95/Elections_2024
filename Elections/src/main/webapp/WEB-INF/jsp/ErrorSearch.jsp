...
<%-- 				<img src="<c:url value="/resources/images/nuts.png" />" alt="image" class="circular_image"/> --%>
				<h1>Sorry, but nothing matched your search terms. Please try again with different keywords.</h1>
			</td>
		</tr>
		<tr>
			<td class="imageContainer" >
<!-- 				<a href="/">  -->
<%-- 				<img src="<c:url value="/resources/images/button-go-back.gif" />" alt="image" /> --%>
<!-- 				</a> -->
			</td>
	</tr>
